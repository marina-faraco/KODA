...
O **KODA CAFE** é um site para uma cafeteria fictícia criado com o objetivo de demonstrar habilidades em desenvolvimento front-end. O projeto contempla desde a apresentação visual da marca até um fluxo funcional de pedidos com carrinho, seleção de entrega e formas de pagamento — simulando uma experiência real de e-commerce para o setor de alimentação.
...
- Seleção entre **retirada no local** ou **delivery**
  - No delivery: campo para informar o endereço de entrega
